...
#       Module created
############################################################################*/
const dncctrl = require('../controllers/plugin.controller.js');
const devctrl = require('../controllers/devmap.controller.js');
...
module.exports = (app) => {
    ...
    app.post('/gdlist', devctrl.getDeviceList);
