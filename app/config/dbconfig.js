...
var errLog = require('../misc/errlogs')

const {DB_HOST, DB_PORT, DB_ROOT_USER, DB_ROOT_PWD} = {... dbconst.envobj}
const {DB_DNC_NAME, DB_DNC_USER, DB_DNC_PWD} = {... dbconst.envobj}

const DB_ROOT_URL = `mongodb://${DB_ROOT_USER}:${DB_ROOT_PWD}@${DB_HOST}:${DB_PORT}`;
const DB_DNC_URL = `mongodb://${DB_HOST}:${DB_PORT}/${DB_DNC_NAME}`;

console.log(DB_ROOT_URL)
console.log(DB_DNC_URL)
